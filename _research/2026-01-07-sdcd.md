...
<div style="display: flex; gap: 20px; margin-bottom: 20px;">
  <div style="flex: 1; text-align: center;">
    <img src="/assets/images/sdcd_ViT_BoP.png" alt="ViT Bag-of-Patches Analysis" style="width: 100%;">
    <p><em>(a) ViT</em></p>
  </div>
  <div style="flex: 1; text-align: center;">
    <img src="/assets/images/sdcd_CLIP_BoP.png" alt="CLIP Bag-of-Patches Analysis" style="width: 100%;">
    <p><em>(b) CLIP</em></p>
  </div>
</div>
